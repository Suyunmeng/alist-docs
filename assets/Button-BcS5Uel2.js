import{C as b,ak as $e,n as E,d as Z,v as p,al as ze,ae as Be,r as S,am as Se,an as Pe,ao as ee,aa as Te,s as y,p as U,q as l,i as ke,ab as Re,H as J,a1 as He,ap as Ie,ac as Ee,aq as Oe,ag as je,a7 as De,ah as Fe,A as R,x as Ne,y as oe,ar as _e,L as Me,M as r,as as H,B as Ke,at as X,P as Ge}from"./app-DwTOaAZ1.js";import{i as qe}from"./browser-ZGkC-3Is.js";const{cubicBezierEaseInOut:C}=$e;function Ve({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 opacity: 0!important;
...
`),Qe=Z({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){ze("-base-wave",We,Be(e,"clsPrefix"));const f=S(null),h=S(!1);let u=null;return Se(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Pe(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}});function z(e){return ee(e,[255,255,255,.16])}function I(e){return ee(e,[0,0,0,.12])}const Le=Te("n-button-group"),Ae=b([E("button",`
 margin: 0;
